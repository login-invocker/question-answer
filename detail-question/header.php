  ...
  <header>
    <div class="header">
      ...
      <div class="header__logo">
        ...
        <div class="header__listpage" id="listpage-mb">
          <ul class="header__list">
            ...
            <li class="header__item">
              <a href="https://question-answer.invocker.repl.co/listquestion.php" class="header__link header__page"> DANH SÁCH CÂU HỎI</a>
            </li>
            <li class="header__item">
      ...
      <div class="header__listpage" id="listpage">
        <ul class="header__list">
          <li class="header__item">
            <a href="https://question-answer.invocker.repl.co/question.php" class="header__link header__page"> ĐẶT CÂU HỎI</a>
          </li>
          <li class="header__item">
            <a href="https://question-answer.invocker.repl.co/listquestion.php" class="header__link header__page"> DANH SÁCH CÂU HỎI</a>
          </li>
