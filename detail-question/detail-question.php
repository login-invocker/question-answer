...
<div id="app">
  <div class="container">
    ...
    <!-- Nếu là bác sĩ thì trả lời -->
    <div v-if="isDoctor" class="col-sm-4">
        ...
        <table>
          ...
          <tr>
            <td>
            Gửi thông tin mà bạn muốn tư vấn.
              
            </td>
          </tr>
        </table>
            <textarea name="" id="content" cols="30" rows="9"></textarea>
            <button type="button" v-on:click="addRawComment()" class="btn btn-primary">Gửi câu trả lời</button>
        </div>
        <br>
        <div class="">
